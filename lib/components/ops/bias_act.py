...
import numpy as np
import torch
from lib.data.utils import EasyDict

from lib.components import custom_ops, nv_misc
...
activation_funcs = {
    ...
    'sin':      EasyDict(func=lambda x, **_:         torch.sin(x),                               def_alpha=0,    def_gain=1,             cuda_idx=None, ref=None, has_2nd_grad=None),
}
